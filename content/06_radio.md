...
desc: 2台以上の micro:bit で、電波を使ってメッセージを送り合おう。
---

{cover}
# 📡 無線でつうしんしよう

micro:bit どうしでメッセージを送り合おう
...
micro:bit には **無線（むせん）** の機能があって、**2台以上の micro:bit** で電波を使ってメッセージを送り合えるよ。

- 送る側と受け取る側の **グループ番号を同じ**にすると、お話しできる
- ちがうグループには聞こえないから、近くでたくさん使っても混ざらないよ

友だちの micro:bit と一緒にためしてみよう！
...
> ⚠ 送る人と受け取る人、**両方の micro:bit** に同じ番号を入れてね。番号がちがうと通じないよ。
...
これで、相手がボタンを押すと、自分の micro:bit にハートが出るよ！
...
2台の micro:bit に同じプログラムを書きこんで、ふってみよう。
