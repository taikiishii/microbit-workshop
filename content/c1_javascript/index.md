...
3. 右がわの「**JS**」をクリック → ブロックが**コードに変身**する
...
![上のまん中にある切りかえボタン。左＝ブロック、右＝JS](image/index/01_toggle.png)
...
このブロックを「JS」に切りかえると、下のコードになるよ。中身はまったく同じだよ。
...
> 同じことをブロックでやると、ブロックがたくさん必要。コードなら数行で書けるのが強みだよ。
...
- 自分が前に作ったプログラムを「**JS**」に切りかえて、中身をのぞいてみよう
