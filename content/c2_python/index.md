...
3. 出てきたメニューから「**Python**」をえらぶ → ボタンが「**PY**」に変わる
4. ブロックにもどすときは、左がわの**パズルのピース**をクリック

> ①の JavaScript と同じ切りかえボタンだよ。「JS」と「PY」は「∨」でいつでも取りかえられる。

> ⚠ 切りかえてもプログラムは消えないよ。何度でも行ったり来たりできるから、こわがらずに押してみよう。

:::

![「∨」からPythonをえらぶ。左＝ブロック、右＝いまの言語](image/index/01_toggle.png)
...
**A** を押すと、5・4・3・2・1 とへっていって「GO!」と出るよ。
...
- 自分が前に作ったプログラムを「**PY**」に切りかえて、中身をのぞいてみよう
- 同じプログラムを「**JS**」にも切りかえて、**書きかたを見くらべよう**
