...
📷 ここにメイクコードの画面：「ずっと」の中に「棒グラフを表示する 値：まわりの音の大きさ 最大値：255」
...
📷 ここにメイクコードの画面：「うるさくなったとき」にびっくり顔、「静かになったとき」にねむり顔の2つのブロック
...
![プログラムの例（アイコンは好きなものにしよう）](image/index/threshold_example.png)
